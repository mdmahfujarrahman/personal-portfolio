...
import mahfuj from '../../asset/mahfuj.png';
import resume from '../../asset/Md Mahfujar Rahman.pdf';
        ...
        <div className="flex flex-col md:flex-row items-center justify-between p-20 container mx-auto">
            ...
            <div className="text-white font-bold mr-0 md:ml-24 lg:mr-40 animate__animated animate__lightSpeedInRight animate__delay-1s">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <p className="text-xl">Jr Full Stack developer</p>
                </div>
                <a
                    href={resume}
                    className="btn btn-outline btn-success my-6"
                    download
                    target="_blank"
                    rel="noreferrer"
                >
